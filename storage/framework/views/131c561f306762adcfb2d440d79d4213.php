...
<form action="<?php echo e(route('mahasiswa.update', $mahasiswa->id)); ?>" method="POST">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            const selectedFakultas = "<?php echo e(old('fakultas', $mahasiswa->fakultas ?? '')); ?>";
            const selectedJurusan = "<?php echo e(old('jurusan', $mahasiswa->jurusan ?? '')); ?>";
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Semester 4\Pemrograman Web\ProjectUAS\StudentListApp\resources\views/mahasiswa/edit.blade.php ENDPATH**/ ?>